...
public class Configs
{
    ...
    public static void loadConfigs(File configFile)
    {
        ...
        prop.comment = "Disables \"regular\" vanilla _ore_ generation, including Nether Quartz. This does not include Emeralds in Extreme Hills biomes, which are not part of the regular ore generation.";
